...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header onCreatePost={session ? openCreateModal : undefined} />
                ...
                <div className="mb-6">
                  ...
                  {session ? (
                    ...
                    <div className="space-y-3">
                      <p className="text-sm text-muted-foreground">Đăng nhập để tạo bài đăng</p>
                      <div className="flex gap-3 justify-center">
                        ...
                        <Link href="/auth/signup">
                          <Button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full">
                            Đăng Ký
                          </Button>
                        </Link>
                      </div>
